...
const getHeaders = (
    ...
    if (encoding === "base64") response["Content-Encoding"] = encoding;
...
export type HttpResponse<T> = ReturnType<typeof buildBaseResponse> & {
    data?: T;
};

export const buildHttpResponse = <T = any>(
    httpContext: HttpContext,
    statusCode: number,
    data: T,
    headers = {},
...
export const buildHttpErrorResponse = (
    ...
    const response: HttpErrorResponse = buildBaseResponse(
        httpContext,
        false,
